                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        ...
                        <?php
                            if (isset($_POST['submit'])) 
                            {
                                ...
                                $res=mysqli_query($con,"insert into forum_message (utilisateur, eleve, sujet, message) values ('$user','$id_eleve','$intitule','$enonce') ") or die("erreur j b");

                               

                                echo('<script>location.href = "home_eleve.php?page=forum"</script>');
