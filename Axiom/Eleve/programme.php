...
<div class="breadcome-area">
        ...
        <div class="text-center m-b-md custom-login"><h1>Programme <?php echo $disp["discipline"]?></h1></div>
                                        ...
                                        while ($row=mysqli_fetch_assoc($result)) 
                                        {
                                            echo '
                                                <tr style="background-color:">
                                                    ...
                                                    <td style="text-align:center"><h4 >Module '.$row["num"].': '.$row["module"].'</h4></td>
                                            ...
                                            while ($rowua=mysqli_fetch_assoc($rcp)) 
                                                {
                                                    echo '
                                                        <tr>
                                                            ...
                                                            <td style="background-color:;text-align:center"><h5><b>UA '.$rowua["num_ua"].': '.$rowua["ua"].'</b></h5> 
