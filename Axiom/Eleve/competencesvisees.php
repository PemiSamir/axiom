        <?php
            ...
            $disp=mysqli_fetch_assoc($result);          
             ...
             // on selectionne l'UA
                ...
                $requet="SELECT competence_lec, id_cl FROM competence_lec WHERE lecon='$lec' and ue='$ue' order by id_cl";
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Compétences visées</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <br><br>
                                    <div class="row">
                                            ...
                                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                                <button class="btn btn-info btn-sm"><a href="home_eleve.php?page=courssituationPB&le=<?=$lec ?>&ua=<?=$ua ?>&id_cours=<?=$id_cours ?>"><span style="color:black"><i class="fa fa-arrow-left"></i> Situation Problème</span></a></button>
                                            </div>
                                            <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2">
                                               
                                            </div>
                                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                                <button class="btn btn-info btn-sm"><a href="home_eleve.php?page=resumevideo&le=<?=$lec ?>&ua=<?=$ua ?>&id_cours=<?=$id_cours ?>"><span style="color:black">Resumé vidéo <i class="fa fa-arrow-right"></i></span></a></button>
                                            </div>
