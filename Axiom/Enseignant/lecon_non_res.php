                                                    ...
                                                    while ($rowue=mysqli_fetch_assoc($uerq)) 
                                                        {
                                                            echo '
                                                                <tr>';
                                                                    ...
                                                                    <td style="text-align:center"><a href="index_enseignant.php?page=cours_non_res&le=<?=$lec ?>&ua=<?=$cua ?>"><h5><b style="color: #2471a3 "><u> UE <?php echo $rowue["num_lec"].': '.$rowue["lecon"]; ?></u></b></h5></a></td>
                                                                    <?php
