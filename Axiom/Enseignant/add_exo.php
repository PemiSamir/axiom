                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <ul class="breadcome-menu">
                                            <li><a href="#">Ajouter Exercice</a> <span class="bread-slash">/</span>
                                            </li>
...
<div class="text-center m-b-md custom-login"><h1>Ajouter un exercice</h1></div>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="panel-heading hbuilt">
                                <div class="p-xs">
                                    <form method="post" class="form-horizontal">
                                        ...
                                        <input type="text" name="typexo" class="hidden" value="exo">
                                        <div class="btn-group">
                        ...
                        <?php
                            if (isset($_POST['submit'])) {
                                ...
                                $res=mysqli_query($con,"insert into exercice (enoncer,ue,type,niveau,intitule) values ('$enonce','$ue','$typ','$niveau','$intitule') ") or die("erreur j b".$enonce." ".$ue);
                                ...
                                echo('<script>location.href = "index_enseignant.php?page=exercice"</script>');
