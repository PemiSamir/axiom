                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <ul class="breadcome-menu">
                                            <li><a href="index_enseignant.php?page=exercice"><b><span style="color:blue">Liste d'exercice</span></b></a> <span class="bread-slash">/</span>
                                            </li>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                                    ...
                                                    <?php echo $exercice["duree"]; ?> Minute
