                    ...
                    <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                        ...
                        <div class="product-payment-inner-st">
                            ...
                            <?php
                             if ((int)$cours["video"]!=0) {
                            ?>
                                 <video controls src="<?php echo $video["chemin"]; ?>" style="width:740px; height:400px"> Vous allez faire sans la Video </video>
                                 <br> <br>
                            <?php
                            }
                            ?>
                            <br>
                                    <div class="row">
                                            ...
                                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                                <button class="btn btn-info btn-sm"><a href="index_enseignant.php?page=competencesvisees&le=<?=$lec ?>&ua=<?=$ua ?>&id_cours=<?=$id_cours ?>"><span style="color:black"><i class="fa fa-arrow-left"></i> Compétences</span></a></button>
                                            </div>
                                            <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2">
                                               
                                            </div>
                                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                                <button class="btn btn-info btn-sm"><a href="index_enseignant.php?page=apercu_cours&le=<?=$lec ?>&ua=<?=$ua ?>&id_cours=<?=$id_cours ?>"><span style="color:black">Resumé Ecrit <i class="fa fa-arrow-right"></i></span></a></button>
                                            </div>
