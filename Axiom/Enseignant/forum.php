                                            ...
                                            <div class="review-content-section">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                                        <button type="button" class="btn btn-custon-rounded-two btn-primary"><a href="index_enseignant.php?page=add_message"><span style="color:white"><i class="fa fa-pencil"></i> Poser Votre Problème</span></a></button>
                                                    </div>
                                                </div>
                                                        ...
                                                        <div class="chat-message">
                                                            ...
                                                            <div class="message">
                                                                ...
                                                                <div class="m-t-md mg-t-10">
                                                                    ...
                                                                    <a class="btn btn-xs btn-warning" href="index_enseignant.php?page=forum_rep&mess=<?=$id_m ?>"><i class="fa fa-eye"></i> <?php echo mysqli_num_rows($reqp); ?> réponses</a>
