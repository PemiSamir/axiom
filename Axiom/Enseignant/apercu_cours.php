                        ...
                        <div class="product-payment-inner-st">
                            ...
                            <br>
                                    <div class="row">
                                            ...
                                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                                <button class="btn btn-info btn-sm"><a href="index_enseignant.php?page=courConso&le=<?=$lec ?>&ua=<?=$ua ?>&id_cours=<?=$id_cours ?>"><span style="color:black">Exercice d'intégration <i class="fa fa-arrow-right"></i></span></a></button>
                                            </div>
