    ...
    <!--div class="error-pagewrap">
        ...
        <br><br><br><br>
            <div class="text-center m-b-md custom-login">
                ...
                <h3>Inscrivez-Vous comme Parent sur Axiom</h3>
                <p></p>
            </div>
                                                    ...
                                                    <form method="post"  enctype="multipart/form-data" action="controller/funct_inscrip.php">
                                                        <div class="row">
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                <input name="role" type="text" class="hidden"  value="parent">
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                ...
                                                                <div class="form-group">
                                                                    <label class="text-left control-label" for="username" >Profession <span style="color:red">*</span></label>
                                                                    <input name="boulo" type="text" class="form-control" placeholder="Work" required="">
                                                                </div>
