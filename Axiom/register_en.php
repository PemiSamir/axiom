    ...
    <!--div class="error-pagewrap">
        <div class="error-page-int"-->
            <div class="text-center m-b-md custom-login">
                ...
                <h3>Inscrivez-Vous comme Enseignant sur Axiom</h3>
                <p></p>
            </div>
                                                    ...
                                                    <form method="post"  enctype="multipart/form-data" action="controller/funct_inscrip.php">
                                                        <div class="row">
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                <input name="role" type="text" class="hidden"  value="enseignant">
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                ...
                                                                <div class="form-group">
                                                                 ...
                                                                 <div class="form-group">
                                                                    <label class="text-left control-label" for="username" >Matricule <span style="color:red">*</span></label>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <select name="Classe" class="form-control" required="">
                                                                            <option value=""></option>
                                                                            <?php 
                                                                                $reket="SELECT code_dep, dpt from departement order by code_dep";
                                                                ...
                                                                <div class="form-group">
                                                                    <label class="control-label" for="username">Grade <span style="color:red">*</span></label>
                                                                    <select name="grade" class="form-control" required=""> 
                                                                        <option value=""></option>
                                                                        <option value="PCEG">PCEG</option>
                                                                        <option value="PLEG">PLEG</option>
                                                                        <option value="PCEG">PCET</option>
                                                                        <option value="PLEG">PLET</option>
