        <?php
            ...
            //on selectionne les information du cours
             ...
             //on sélectionne l'exercice
              $requet="SELECT * FROM exercice WHERE source='$id_cours' and type='SP'";
              $result=mysqli_query($con,$requet) or die("impossible d'exécuter la requet");
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Situation problème</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                ...
                <div class="row">
                    <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                        <div class="product-payment-inner-st">
                            <div class=" m-b-md custom-login"><h3 style="color:">Situation Problème</h3></div><br>
                             ...
                             else
                             {
                                ...
                                $i=0;
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                                <button class="btn btn-info btn-sm"><a href="home_eleve.php?page=rappelPrerequis&le=<?=$lec ?>&ua=<?=$ua ?>&id_cours=<?=$id_cours ?>"><span style="color:black"><i class="fa fa-arrow-left"></i> Rappel et Prerequis</span></a></button>
                                            </div>
                                            <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2">
                                               
                                            </div>
                                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                                <button class="btn btn-info btn-sm"><a href="home_eleve.php?page=competencesvisees&le=<?=$lec ?>&ua=<?=$ua ?>&id_cours=<?=$id_cours ?>"><span style="color:black">Compétences visées <i class="fa fa-arrow-right"></i></span></a></button>
                                            </div>
                                ...
                                <div class="profile-details-hr">
                                    ...
                                    <div class="row">
                                        ...
                                        <ul style="font-size:16">
                                            ...
                                            <li><span style="text-align:center; font-family:Times new roman"><a href="#"><h5  style="color:red">Situation Problème</h5></a></span></li>
                                            ...
                                            <li><span style="text-align:center; font-family:Times new roman"><a href="home_eleve.php?page=resumevideo&le=<?=$lec ?>&ua=<?=$ua ?>&id_cours=<?=$id_cours ?>"><h5>Resumé Vidéo</h5></a></span></li>
