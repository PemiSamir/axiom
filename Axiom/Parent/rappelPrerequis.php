                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Rappel et prérequis</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                             ...
                             else
                             {
                                ...
                                $i=0;
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                                <button class="btn btn-info btn-sm"><a href="home_eleve.php?page=courssituationPB&le=<?=$lec ?>&ua=<?=$ua ?>&id_cours=<?=$id_cours ?>"><span style="color:black">Situation Problème <i class="fa fa-arrow-right"></i></span></a></button>
                                            </div>
