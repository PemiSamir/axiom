<?php
        ...
        $requet="SELECT nom, photo FROM parent WHERE id='$idp'";
        $resul=mysqli_query($con,$requet) or die("impossible d'exécuter la requet");
        $inf=mysqli_fetch_assoc($resul);
                                    ...
                                    <div class="col-lg-6 col-md-5 col-sm-12 col-xs-12">
                                        <div class="header-right-info">
                                            <ul class="nav navbar-nav mai-top-nav header-right-menu">
                                                <li class="nav-item"><a href="#" class="nav-link"><span class="admin-name">
                                                 <b><?php echo $info['Nom'].' de '.$info['classe']; ?>
                                                </b></span></a>
                                                </li>
                                                ...
                                                <li class="nav-item">
                                                    <a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle">
															<img src="<?php echo $inf['photo']; ?>" alt="" />
															<span class="admin-name"><?php echo $inf['nom']; ?></span>
