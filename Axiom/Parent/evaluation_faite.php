<?php
        ...
        $requet="SELECT id_eval, intitule_eval, total_point, date, duree_eval, statut, type, ue FROM evaluation WHERE id_eval IN(SELECT eval FROM eval_fait WHERE eleve='$id_eleve') and ue IN(SELECT code FROM discipline_classe WHERE classe='$classe') order by date desc";
...
<div class="breadcome-area">
        ...
        <div class="text-center m-b-md custom-login"><h1>Les Evaluations faites</h1></div>
        <div class="breadcome-area">
                <div class="container-fluid">
                    <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="sparkline13-list">
                            ...
                            <h4>Liste des évaluations déjà traitées</h4>
                            ...
                            <div class="sparkline13-graph">
                                ...
                                <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                    ...
                                    ?>
                                        ...
                                        <td>
                                            <button data-toggle="tooltip" title="Aperçu" class="pd-setting-ed btn-info"><a href="home_eleve?page=apercu_eval&eval=<?=$id_eval ?>" target="_blank"><i class="fa fa-eye" style="color:blue" aria-hidden="true"></i></a></button>
                                        </td>
