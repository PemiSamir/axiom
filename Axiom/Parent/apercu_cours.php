                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" >
                            <div class="breadcome-list single-page-breadcome" style="background-color:azure">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Resumé écrit</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                ...
                <div class="row">
                    <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                        <div class="product-payment-inner-st" >
                            <div class="text-center m-b-md custom-login"><h3 style="color:">Resumé Ecrite</h3></div><br>
                            ...
                            <br>
                                    <div class="row">
                                            ...
                                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                                <button class="btn btn-info btn-sm"><a href="home_eleve.php?page=resumevideo&le=<?=$lec ?>&ua=<?=$ua ?>&id_cours=<?=$id_cours ?>"><span style="color:black"><i class="fa fa-arrow-left"></i> Resumé vidéo</span></a></button>
                                            </div>
                                            <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2">
                                               
                                            </div>
                                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                                                <button class="btn btn-info btn-sm"><a href="home_eleve.php?page=courConso&le=<?=$lec ?>&ua=<?=$ua ?>&id_cours=<?=$id_cours ?>"><span style="color:black">Exercice d'intégration <i class="fa fa-arrow-right"></i></span></a></button>
                                            </div>
                                ...
                                <div class="profile-details-hr">
                                    ...
                                    <div class="row">
                                        ...
                                        <ul style="font-size:16">
                                            ...
                                            <li><span style="text-align:center; font-family:Times new roman"><a href="#"><h5 style="color:red">Resumé Ecrit</h5></a></span></li>
